...
public class TutorialHandler : MonoBehaviour
{
    ...
    public Dictionary<EventType, string> events = new Dictionary<EventType, string>()
    {
        ...
        {EventType.Microbacteria, "You just produced your first microbacteria! These are your friends. You can select them by holding left mouse button and dragging over them."},
